...
public abstract class BlockWallPlant extends BlockPlant{
	...
	public void setBlockBoundsBasedOnState(IBlockAccess world, int x, int y, int z){
		...
		} else if (world.getBlock(x + 1, y, z).isNormalCube()){ //Checks the East block
		...
		} else { //Defaults to the West side - This method only gets called if it can stay, so it must have a block somewhere
